...
function validateInvoice(){
         $errors = []; 
                ...
                validateInvoiceNumber($invoice_number, $errors);
                validateInvoiceDate($invoice_date, $errors);
                validateCustomerName($customer_name, $errors);
                validateCustomerEmail($customer_email, $errors);
                validateInvoiceItems($items, $errors);
